...
class QueueAlreadyExists(RedisSMQException):
    ...
    def __init__(self, name):
        """Constructor"""
        super(QueueAlreadyExists, self).__init__("Queue '%s' already exists" % name)
...
class QueueDoesNotExist(RedisSMQException):
    ...
    def __init__(self, name):
        """Constructor"""
        super(QueueDoesNotExist, self).__init__("Queue '%s' does not exist" % name)
...
class NoMessageInQueue(RedisSMQException):
    ...
    def __init__(self, name):
        """Constructor"""
        super(NoMessageInQueue, self).__init__("Queue '%s' has no messages waiting" % name)
